  ...
  getUIText(key) {
    const translations = {
      ...
      'changelog.infoTooltip': {
        ko: '・날짜를 클릭하면 해당 날짜의 변경사항을 펼치거나 접을 수 있습니다.<br>・필터 버튼으로 카테고리별 항목을 선택해서 볼 수 있습니다.<br>・블로그 항목의 🔗 링크를 클릭하면 해당 커밋을 확인할 수 있습니다.',
        ja: '・日付をクリックすると、その日付の変更事項を展開・折りたたむことができます。<br>・フィルターボタンでカテゴリーごとに表示できます。<br>・ブログ項目の🔗リンクをクリックすると、該当コミットを確認できます。'
      }
    };
