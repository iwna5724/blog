...
<!-- /ja -->`;
  ...
  getUIText(key) {
    const translations = {
      ...
      'music.infoTooltip': {
        ko: '・이 페이지에서는 제가 좋아하는 앨범들을 정리하고 있습니다.<br>・앨범 커버를 클릭하면해당 앨범에 대한 정보를 확인할 수 있습니다.<br>・"CD"란, 실제 피지컬 CD를 구매한 앨범/EP를 의미합니다.<br><br>・선호도(별점)은 어디까지나 저의 주관적인 감상이며, 작품성에 대한 평가가 아닙니다.<br>・선호도는 특정한 기준 없이 매우 직감적인 판단에 따르기 때문에, 실제 선호도와 약간의 차이가 있을 수 있습니다.<br>・선호도가 1점이라고 해서 해당 앨범을 좋아하지 않는다는 것을 의미하지는 않습니다. ',
        ja: '・このページでは、自分が好きなアルバムをまとめています。<br>・アルバムカバーをクリックすると、そのアルバムに関する情報を確認することができます。<br>・「CD」とは、実際にフィジカルCDを購入したアルバム/EPを意味します。<br><br>・選好度(星評価)はあくまでも自分の主観的な感想であり、作品性に対する評価ではありません。<br>・選好度は特定の基準がなく非常に直感的な判断によるため、実際の選好度と若干の違いがある場合があります。<br>・選好度が1点だからといって、当該アルバムが好きでないという意味ではありません。'
      },
      'music.artistAlbum': {
        ko: '아티스트・앨범명',
        ja: 'アーティスト・アルバム名'
