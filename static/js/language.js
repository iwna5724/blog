...
<!-- /ja -->`;
  ...
  getUIText(key) {
    const translations = {
      ...
      'music.infoTooltip': {
        ko: '・앨범 커버를 클릭하면해당 앨범에 대한 정보를 확인할 수 있습니다.<br>・"CD"란, 실제 피지컬 CD를 구매한 앨범/EP를 의미합니다.<br>・선호도(별점)은 어디까지나 저의 주관적인 감상이며, 작품성에 대한 평가가 아닙니다.',
        ja: '・アルバムカバーをクリックすると、そのアルバムに関する情報を確認することができます。<br>・「CD」とは、実際にフィジカルCDを購入したアルバム/EPを意味します。<br>・選好度(星評価)はあくまでも自分の主観的な感想であり、作品性に対する評価ではありません。'
      },
      'music.artistAlbum': {
        ko: '아티스트・앨범명',
        ja: 'アーティスト・アルバム名'
      ...
      'music.ratingDesc1': {
        ko: ' 취향에는 맞지만, 아직 충분할 정도로 많이는 듣지 않음',
        ja: ' 好みには合うが、まだ十分なほど多くは聴いてない'
      },
      'music.ratingDesc2': {
        ko: ' 꽤 많이 들었지만, 아직 "애정을 가지고 있다" 라고는 할 수 없음',
        ja: ' かなり聴いたが、まだ「愛着がある」とは言えない'
      },
      'music.ratingDesc3': {
        ko: ' 애정은 가지고 있지만, 머릿속에서 자동으로 재생될 정도의 수준은 아님',
        ja: ' 愛着はあるが、頭の中で自動的に再生されるほどのレベルではない'
      },
      'music.ratingDesc4': {
        ko: ' 정말 많이 들었지만, 앨범 자체의 이해도는 다소 낮음',
        ja: ' 本当にたくさん聴いたが、アルバム自体の理解度はやや低い'
      },
      'music.ratingDesc5': {
        ko: ' GOAT',
        ja: ' GOAT'
