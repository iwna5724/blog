  ...
  getUIText(key) {
    const translations = {
      ...
      'music.infoTooltip': {
        ...
        ja: '・このページでは、自分が好きなアルバムをまとめています。<br>・アルバムカバーをクリックすると、そのアルバムに関する情報を確認することができます。<br>・Spotifyと同じバージョンの音楽/動画がある場合、YouTube Musicのリンクも表示されます。<br>・「CD」とは、実際にフィジカルCDを購入したアルバム/EPを意味します。<br><br>・選好度(星評価)はあくまでも自分の主観的な感想であり、作品性に対する評価ではありません。<br>・選好度は特定の基準がなく非常に直感的な判断によるため、実際の選好度と若干の違いがある場合があります。<br>・選好度が1点だからといって、当該アルバムが好きでないという意味ではありません。優先順位が低いだけです。<br>・リストはなるべくアルバム中心に構成されることを願うため、EPには選好度-1を、シングルには-2のペナルティを反映しています。<br>→つまり、選好度が5点のシングルは実質7程度の選好を意味します。'
      },
      'music.artistAlbum': {
        ko: '아티스트・앨범명',
        ja: 'アーティスト・アルバム名'
