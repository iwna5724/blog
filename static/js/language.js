...
<!-- /ja -->`;
  ...
  getUIText(key) {
    const translations = {
      ...
      'music.infoTooltip': {
        ko: '・앨범 커버를 클릭하면해당 앨범에 대한 정보를 확인할 수 있습니다.<br>・모바일 환경에서는 모달을 좌우로 스와이프 시 다음 앨범으로 이동할 수 있습니다.<br>・"CD"란, 실제 피지컬 CD를 구매한 앨범/EP를 의미합니다.<br><br>・선호도(별점)은 어디까지나 저의 주관적인 감상이며, 작품성에 대한 평가가 아닙니다.<br>・선호도는 특정한 기준 없이 매우 직감적인 판단에 따르기 때문에, 실제 선호도와 약간의 차이가 있을 수 있습니다.',
        ja: '・アルバムカバーをクリックすると、そのアルバムに関する情報を確認することができます。<br>・モバイル環境では、モーダルを左右にスワイプすると次のアルバムへ移動できます。<br>・「CD」とは、実際にフィジカルCDを購入したアルバム/EPを意味します。<br><br>・選好度(星評価)はあくまでも自分の主観的な感想であり、作品性に対する評価ではありません。<br>・選好度は特定の基準がなく、非常に直感的な判断に基づくため、実際の選好度と多少の差が生じることがあります。'
      },
      'music.artistAlbum': {
        ko: '아티스트・앨범명',
        ja: 'アーティスト・アルバム名'
...
'changelog.filterMusic': {
      ...
      'changelog.infoTooltip': {
        ko: '・날짜를 클릭하면 해당 날짜의 변경사항을 펼치거나 접을 수 있습니다.<br>・필터 버튼으로 카테고리별 항목을 선택해서 볼 수 있습니다.<br>・🔗 링크를 클릭하면 해당 커밋을 확인할 수 있습니다.<br><br>・변경사항은 26/02/18 이후의 내용만 기록됩니다.<br>・또한, 변경사항 페이지에는 열람자 입장에서 체감 가능한 내용만 기록됩니다.<br>・버그 수정 등의 기타 변경사항은 <a href="https://github.com/iwna5724/blog/actions/workflows/deploy.yml" target="_blank" class="read-more" rel="noopener noreferrer">깃허브(2026년 이후)</a> 혹은 <a href="https://bit.ly/iwna5724" target="_blank" class="read-more" rel="noopener noreferrer">클라우드(2025년 이전)</a>에서 확인 가능합니다.',
        ja: '・日付をクリックすると、その日付の変更事項を展開・折りたたむことができます。<br>・フィルターボタンでカテゴリーごとに表示できます。<br>・🔗リンクをクリックすると、該当コミットを確認できます。<br><br>・変更事項は26/02/18以降の内容のみ記録されます。<br>・また、変更事項ページでは閲覧者側で体感できる内容のみ記録されます。<br>・バク修正などその他の変更事項は<a href="https://github.com/iwna5724/blog/actions/workflows/deploy.yml" target="_blank" class="read-more" rel="noopener noreferrer">Github(2026年以降)</a>または<a href="https://bit.ly/iwna5724" target="_blank" class="read-more" rel="noopener noreferrer">クラウド(2025年以前)</a>から確認できます(韓国語のみ)。'
      }
    };
